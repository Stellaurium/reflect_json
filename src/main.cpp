...
int main() {
    auto person1 = Person<double>{.name = "John", .age = 30, .city = "New York", .balance = 12.0};
    auto person2 = Person<int>{.name = "Alex", .age = 30, .city = "Beijing", .balance = 15};
    ...
    fmt::print("name: {}, age: {}, city: {}, balance: {}\n", var.name, var.age, var.city, var.balance);
